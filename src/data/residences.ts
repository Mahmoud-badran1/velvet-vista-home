...
export const residences: Residence[] = [
  ...
  },
  {
    ...
    order: 2,
    image: "swBath",
    gallery: ["swBath", "swCorridor", "swBath2", "swShower", "swStair", "swHall", "swDining", "swDining2", "swTerrace", "swHall2", "swBath3", "swBath4", "swNook", "swStudy", "swReading", "swStudyEvening", "swVanity2"],
