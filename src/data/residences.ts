...
export const residences: Residence[] = [
  {
    ...
    outdoor: "60 m²",
    rooms: "5",
    status: { de: "Erstbezug – Fertigstellung Mai 2026", en: "First occupancy – completed May 2026" },
    price: { de: "Preis auf Anfrage", en: "Price on request" },
    intro: {
      de: "Großzügiger Dachausbau mit Panoramablick in begehrter Wiener Bestlage: 168 m² Wohnfläche, 60 m² Terrassen und ein 70 m² Salon.",
      en: "Generous roof extension with panoramic views in a sought-after Viennese location: 168 m² of living space, 60 m² of terraces and a 70 m² salon.",
    },
    description: {
      de: [
        "Eine außergewöhnliche Immobilie für anspruchsvolle Käufer, die großzügiges Wohnen, private Außenflächen und eine zentrale Lage in Wien miteinander verbinden möchten.",
        "In einem historischen Gründerzeithaus aus der Zeit um 1890 wurde diese exklusive Terrassenwohnung im Zuge eines Dachausbaus neu geschaffen. Die Baufertigstellung erfolgte im Mai 2026, somit handelt es sich um einen Erstbezug.",
        "Die Wohnung erstreckt sich über zwei Etagen und verfügt über rund 168 m² Wohnfläche. Zusätzlich stehen zwei großzügige Terrassen mit insgesamt ca. 60 m² zur Verfügung.",
        "Besonders beeindruckend sind die durchgehenden Panoramafenster in beiden Blickrichtungen. Eine rund 10 Meter lange Glasfront öffnet den Salon zur Stadtterrasse, während die Südterrasse den Blick in Richtung Innenhof ermöglicht.",
        "Das Herzstück der Wohnung bildet der rund 70 m² große Salon. Die großzügige Glasfront mit einer Länge von rund 10 Metern schafft eine außergewöhnliche Verbindung zwischen Innenraum und Stadtterrasse. Die großen Panoramafenster sorgen für viel Tageslicht und eröffnen besondere Ausblicke.",
        "Die Wohnung bietet insgesamt 5 Zimmer auf zwei Etagen: Salon mit ca. 70 m², Küche, Büro, 3 Schlafzimmer, 2 Bäder en suite, 2 separate WCs, Erschließungs- und Nebenflächen sowie zwei Terrassen.",
        "Die Wohnräume verfügen über massive, gewachste Teakparkettböden. Für angenehme Temperaturen sorgt eine Gasetagen-Fußbodenheizung. In den Bädern steht zusätzlich eine elektrische Fußbodenheizung zur Verfügung. Ein Klimagerät sorgt während der warmen Jahreszeit für zusätzlichen Wohnkomfort. Der Energieausweis weist einen HWB-Wert von 47,7 kWh/m²a – Klasse B aus.",
        "Ein besonderes Merkmal dieser Immobilie ist das private Zugangskonzept. Der Hauseingang und die Garage sind über einen Direktlift erschlossen, der ausschließlich von den Bewohnern der beiden Penthouse-Etagen genutzt werden kann. Dadurch entstehen ein hohes Maß an Privatsphäre, Sicherheit und Diskretion. Zusätzlich steht dem Wohnungseigentümer im Keller ein eigener Lagerraum zur Verfügung.",
        "Die Immobilie befindet sich in einer bürgerlich-eleganten und etablierten Wohnlage im 8. Wiener Gemeindebezirk. Die Umgebung bietet eine vielseitige Infrastruktur mit Ärzten, Bildungseinrichtungen, Nahversorgern, Handwerksbetrieben, Cafés, Restaurants und kulturellen Einrichtungen. Durch die Nähe zum AKH ist die Lage auch für Personen interessant, die eine gute Erreichbarkeit medizinischer Einrichtungen schätzen. Mehrere U-Bahn-Linien (U2, U3, U5) befinden sich in Gehweite, wodurch die Wiener Innenstadt in kurzer Zeit erreichbar ist. Die Gasse soll künftig zu einer verkehrsberuhigten Begegnungszone mit zusätzlicher Begrünung umgestaltet werden.",
        "Die derzeitigen Hausbetriebskosten betragen ca. € 700,- / Monat. Der Garagenplatz kostet ca. € 270,- / Monat. Die genannten laufenden Kosten basieren auf den derzeit vorliegenden Angaben und können sich ändern.",
        "Der Vermittler ist als Doppelmakler tätig.",
      ],
      en: [
        "An extraordinary property for discerning buyers seeking generous living space, private outdoor areas and a central location in Vienna.",
        "This exclusive terrace apartment was newly created as part of a roof extension in a historic Gründerzeit building from around 1890. Construction was completed in May 2026, making this a first-time occupancy.",
        "The apartment extends across two floors and offers around 168 m² of living space. In addition, two generous terraces totalling approx. 60 m² are available.",
        "Particularly impressive are the continuous panoramic windows facing in both directions. A glass front of around 10 metres opens the salon to the city terrace, while the south terrace offers views towards the inner courtyard.",
        "The heart of the apartment is the salon of around 70 m². The generous glass front, approximately 10 metres long, creates an exceptional connection between interior and city terrace. The large panoramic windows provide abundant natural light and open up special views.",
        "The residence offers a total of 5 rooms across two floors: salon of approx. 70 m², kitchen, study, 3 bedrooms, 2 en-suite bathrooms, 2 separate WCs, circulation and ancillary spaces, and two terraces.",
        "The living rooms feature solid, waxed teak parquet flooring. Gas underfloor heating provides pleasant temperatures. The bathrooms additionally have electric underfloor heating. An air-conditioning unit provides extra comfort during the warmer months. The energy certificate shows an HWB value of 47.7 kWh/m²a – class B.",
        "A special feature of this property is the private access concept. The entrance and garage are accessed via a direct lift reserved exclusively for residents of the two penthouse floors. This creates a high degree of privacy, security and discretion. In addition, the owner has a private storage room in the cellar.",
        "The property is located in a bourgeois-elegant and established residential area in Vienna's 8th district. The surroundings offer a diverse infrastructure with doctors, educational facilities, local suppliers, craft businesses, cafés, restaurants and cultural institutions. Proximity to the AKH makes the location particularly attractive for those who value good access to medical facilities. Several underground lines (U2, U3, U5) are within walking distance, making Vienna's city centre quickly accessible. The street is planned to be converted into a traffic-calmed meeting zone with additional greenery.",
        "Current operating costs are approx. € 700 per month. The garage space costs approx. € 270 per month. The stated running costs are based on the information currently available and are subject to change.",
        "The agent acts as a dual agent.",
      ],
    },
    features: {
      de: ["ca. 168 m² Wohnfläche", "5 Zimmer", "Auf zwei Etagen", "Erstbezug – Fertigstellung Mai 2026", "Dachausbau in historischem Gründerzeithaus, Baujahr um 1890", "Zwei Terrassen mit insgesamt ca. 60 m²", "Ca. 10 Meter lange Glasfront", "Großzügige Panoramafenster", "Ca. 70 m² großer Salon", "Küche", "Büro", "3 Schlafzimmer", "2 Bäder en suite", "2 separate WCs", "Massive Teakparkettböden", "Fußbodenheizung", "Elektrische Bad-Fußbodenheizung", "Klimagerät", "Privater Direktlift", "Eigener Hauseingang", "Private Garage", "Zusätzlicher Lagerraum im Keller", "HWB 47,7 kWh/m²a – Klasse B"],
      en: ["Approx. 168 m² living space", "5 rooms", "Across two floors", "First occupancy – completed May 2026", "Roof extension in historic Gründerzeit building, built around 1890", "Two terraces totalling approx. 60 m²", "Glass front approx. 10 metres long", "Generous panoramic windows", "Salon approx. 70 m²", "Kitchen", "Study", "3 bedrooms", "2 en-suite bathrooms", "2 separate WCs", "Solid teak parquet flooring", "Underfloor heating", "Electric bathroom underfloor heating", "Air-conditioning", "Private direct lift", "Private entrance", "Private garage", "Additional cellar storage room", "HWB 47.7 kWh/m²a – class B"],
    },
  },
  {
